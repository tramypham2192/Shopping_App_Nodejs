...
module.exports = {
  ...
  register: async (req, res) => {
    ...
    const emailList = await sequelize
  ...
  getCart: async (req, res) => {
    ...
    return res
      .status(200)
      .send([{ user_firstname: user_firstname }, responseData]);
  },
  ...
  insertIntoCart: async (req, res) => {
    ...
    await sequelize
      .query(`select products_in_cart from carts where user_id = ${user_id};`)
      .then((dbres) => {
    ...
    if (products_in_cart == "") {
      ...
      if (checkExistingProductInCart == null) {
        ...
        checkExistingProductInCart != null &&
        checkExistingProductInCart.product_quantity == 0
      ) {
